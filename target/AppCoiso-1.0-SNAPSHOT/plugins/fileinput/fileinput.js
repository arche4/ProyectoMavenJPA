...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _readFiles: function (files) {
            ...
            readFile = function (i) {
                $("#dataInfo [type='submit']").remove();//Cambio 23022017
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'Archivo',
        filePlural: 'Archivos',
        browseLabel: 'Cargar archivo &hellip;',
        removeLabel: 'Eliminar',
        removeTitle: 'Limpiar select archivos',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Subir',
        uploadTitle: 'Subir Archivo seleccionado',
        msgNo: 'No',
        msgNoFilesSelected: 'No se selecciono archivo',
        msgCancelled: 'Cancelado',
        msgZoomModalHeading: 'Vista del archivo',
